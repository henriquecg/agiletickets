...
public class EspetaculosController {
	...
	@Post
	@Path("/espetaculos")
	private void validadeDadosEspetaculo(Espetaculo espetaculo) {
	...
	public void adiciona(Espetaculo espetaculo) {
		...
		validadeDadosEspetaculo(espetaculo);
	...
	private void validaDadosParaReserva(Long sessaoId,
	...
	public void reserva(Long sessaoId, final Integer quantidade) {
		...
		validaDadosParaReserva(sessaoId, quantidade, sessao);
